        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex justify-end m-2 p-2">
                    <a href="{{ route('admin.menus.create') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white dark:bg-gray-900 dark:border-gray-700">
                        New Menu
                    </a>
                </div>
                <!-- menus table -->
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex space-x-2">
                                        ...
                                        <form class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white" method="POST" action="{{ route('admin.menus.destroy', $menu->id) }}" onsubmit="return confirm('Are you sure?');">
                                            @csrf
                                            @method('DELETE')
                                            <button onsubmit="confirm('delete!!\nAre You Sure?');" type="submit">Delete</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
