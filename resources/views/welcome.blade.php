<x-guest-layout>
    <!-- Main Hero Content -->
    <div class="container max-w-lg bg-center bg-no-repeat bg-cover md:max-w-none " style="background-image: url('https://cdn.pixabay.com/photo/2016/11/18/14/39/beans-1834984_960_720.jpg')">
            <div class="overlay px-4 py-32 mx-auto text-left md:text-center">
            ...
            > -->
                ...
                <div class="w-full md:w-1/2">
                    <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                        <img src="https://cdn.pixabay.com/photo/2017/08/03/13/30/people-2576336_960_720.jpg" alt="img" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="order-1 w-full px-3 lg:w-1/2 lg:order-0">
                    <div class="w-full lg:max-w-md">
                        ...
                        <p class="mb-4 font-medium tracking-tight text-gray-400 xl:mb-6">
                            At TailFood Restaurant, we deliver an exceptional dining experience that sets us apart.
